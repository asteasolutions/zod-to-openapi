 ...
 */
const multipleOpenApi = z.string()
  .openapi('Initial')
  .min(3)
  .openapi('WithMin')
  .optional()
 ...
 */
function addOpenApiToSchema<T extends z.ZodTypeAny>(schema: T, name: string): T {
...
const problematicUnion = z.union([
 ...
 */
const deeplyNestedUnion = z.union([
  z.object({
 ...
 */
const veryLongTypeName = z.string().openapi('AVeryLongTypeNameThatMightCauseIssuesInTypescriptCompilationIfNotHandledProperly');
 ...
 */
const integrationTest = z.object({
